...
import { View, Text, StyleSheet, TouchableHighlight, ActivityIndicator, FlatList, Image} from "react-native";
...
export default function MoviesList({ navigation }) {
  ...
  useEffect(() => {
    axios.get(`https://movie-api.igeargeek.com/movies`).then((res) => {
